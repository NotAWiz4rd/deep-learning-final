...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        from transformer_modules import Block
    ...
    def configure_optimizers(self, weight_decay, learning_rate, device):
        ...
        # i.e. all weight tensors in matmuls + embeddings decay, all bias and LayerNorm/BatchNorm parameters don't
        ...
        # Create AdamW optimiser and use the fused version if it is availabe
